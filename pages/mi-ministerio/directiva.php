...
<body>
                        ...
                        <div class="col-12 col-md-8">
                            ...
                            <nav class="breadcrumb-container d-inline-block">
                                <ul class="breadcrumb pt-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="./">Mi Ministerio</a></li>
    ...
    <script>
        ...
        window.eliminarCargo = function(slug, nombre) {
            ...
            fetch(siteURL + 'pages/mi-ministerio/actualizar-directiva.php', {
                method: 'POST',
                body: formData
            })
        ...
        document.getElementById('formDirectiva').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                const response = await fetch(siteURL + 'pages/mi-ministerio/actualizar-directiva.php', {
                    method: 'POST',
                    body: formData
                });
